package com.marlow.logservice.configuration;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, MyMsg> consumerFactory() {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.marlow.logservice.DTO.MyMsg");
        config.put(JsonDeserializer.USE_TYPE_INFO_HEADERS,false);
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "*");

        //config.put("spring.json.type.mapping", "com.marlow.accountservice.DTO.MyMsg:com.marlo.logservice.DTO.MyMsg");    // This config tells mapper that these two classes although in different package but are same.
